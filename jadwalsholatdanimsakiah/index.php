...
<head>
  ...
  <title>Muslim Web - Jadwal Sholat & Imsakiyah</title>
    ...
    <div id="content">
      ...
      <header class="main_haeder multi_item">
        ...
        <div class="title_page">
          <span class="page_name">Jadwal Sholat & Imsakiyah</span>
        </div>
        <div class="em_side_right">
      ...
      <!-- Start Jadwal Sholat Section -->
      <main class="container mt-4 animate__animated animate__fadeIn">
        <div class="view-mode text-center mb-3">
          <button class="view-option active" data-view="daily">HARI</button>
          <button class="view-option" data-view="monthly">BULAN</button>
          <label for="citySelect" class="form-label ms-3" style="display: inline-block;">Pilih Kota:</label>
          <select id="citySelect" class="form-select" style="display: inline-block; width: auto;"></select>
        </div>
